...
// <auto-generated>
//
// Generated from file `_Glacier2SessionDisp.java'
//
...
public abstract class _Glacier2SessionDisp extends Ice.ObjectImpl implements Glacier2Session
{
    ...
    ___getLibrary(Glacier2Session __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        LibraryPrx __ret = __obj.getLibrary(__current);
        LibraryPrxHelper.__write(__os, __ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___refresh(Glacier2Session __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 1:
            {
                return ___getLibrary(this, in, __current);
            }
            case 2:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type Demo::Glacier2Session was not generated with stream support";
        throw ex;
    }
