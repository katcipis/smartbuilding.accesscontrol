...
// <auto-generated>
//
// Generated from file `_LibraryOperations.java'
//
 ...
 * 
 **/
public interface _LibraryOperations
{
    /**
     ...
     **/
    void queryByIsbn(String isbn, int n, BookDescriptionSeqHolder first, Ice.IntHolder nrows, BookQueryResultPrxHolder result, Ice.Current __current);
     ...
     * @param __current The Current object for the invocation.
     **/
    void queryByAuthor(String author, int n, BookDescriptionSeqHolder first, Ice.IntHolder nrows, BookQueryResultPrxHolder result, Ice.Current __current);
     ...
     * @param __current The Current object for the invocation.
     **/
    void queryByTitle(String title, int n, BookDescriptionSeqHolder first, Ice.IntHolder nrows, BookQueryResultPrxHolder result, Ice.Current __current);
     ...
     * 
     **/
    BookPrx createBook(String isbn, String title, java.util.List<String> authors, Ice.Current __current)
