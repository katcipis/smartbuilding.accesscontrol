...
// <auto-generated>
//
// Generated from file `_SessionFactoryDelD.java'
//
...
public final class _SessionFactoryDelD extends Ice._ObjectDelD implements _SessionFactoryDel
{
    public SessionPrx
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    SessionFactory __servant = null;
                    try
                    {
                        __servant = (SessionFactory)__obj;
                    }
                    catch(ClassCastException __ex)
                    {
                        throw new Ice.OperationNotExistException(__current.id, __current.facet, __current.operation);
                    }
                    __result.value = __servant.create(__current);
    ...
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "getSessionTimeout", Ice.OperationMode.Nonmutating, __ctx);
